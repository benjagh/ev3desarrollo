			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						...
						<a href="<?php echo base_url(); ?>ShowForm/tipo_de_producto/main" class="list-group-item active">
							Tipo de producto</a>
					   ...
					   <div class="col-md-9">
								<div class="rounded-0 panel panel-default">
								  ...
								  <div class="panel-body">
									  ...
									  <div class="row">
									  <div class="col-md-3">
										  <?php echo form_open_multipart('Insert/tipo_de_producto'); ?>
										  <div class="box-body">
<!--											  <p  style="font-size: 20px; color: #066;">--><?php //echo $msg; ?><!--</p>-->
											  <div class="form-group" style="width: 400px;">
												  <label for="tipo_de_producto">Tipo de producto</label>
												  <input type="text" class="form-control" id="tipo_de_producto" placeholder="" name="tipo_de_producto">
											  </div>
										  </div>
								   ...
								   <div class="panel-body">
									   <table class="table table-striped table-bordered table-hover">
										   ...
										   <tr>
											   ...
											   <th style="text-align: center;">Tipos de productos</th>
										   ...
										   foreach ($all_value as $single_value) {
											   ...
											   <tr>
												   ...
												   <td><?php echo $single_value->tipo_de_producto; ?></td>
												   <td style="text-align: center;">
													   <a style="margin: 5px;" class="btn btn-danger btn-sm rounded-0"
														  href="<?php echo base_url(); ?>Delete/tipo_de_producto/<?php echo $single_value->tipo_producto_id; ?>">Borrar
													   </a>
												   </td>
											   </tr>
										   <?php } ?>
