...
<div class="box-body table-responsive" style="width: 100%; color: black;">
	...
	<table id="example2" class="table table-bordered table-hover">
		...
		<tr>
			<th colspan="8">
				<p style="text-align: center; font-weight: bold;">Supplier Name: <?php echo $nombre_proveedor; ?></p>
			</th>
		</tr>
		<tr>
		...
		foreach ($all_value as $single_value) {
			...
			<tr>
				...
				<td><?php echo $single_value->informe_detallado; ?></td>
				<td><?php echo $single_value->nombre_proveedor; ?></td>
				<td style="text-align: right;">
					<?php if($single_value->informe_detallado =="Purchase Medicine"){?>
						<?php echo '$'.($single_value->compra_vencida+$single_value->compra_pagada); ?>
					<?php }else{echo '$'.$single_value->precio_compra;}?>
				</td>
				<td style="text-align: right;">$<?php echo $single_value->compra_pagada; ?></td>
				<td style="text-align: right;">$<?php echo $single_value->compra_vencida; ?></td>
