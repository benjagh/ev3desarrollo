                                    ...
                                    <tr class="<?= (date("Y-m-d") >= $single_value->fecha_caducidad) ? 'expired' : '' ?>">
                                        ...
                                        <td style="text-align: center;">
											<a style="margin: 5px;" title="Update"
											   href="<?php echo base_url(); ?>ShowForm/informacion_de_compra/<?php echo $single_value->compra_id; ?>">
												<span class="glyphicon glyphicon-edit"></span>
											</a>
                                            <a style="margin: 5px;" title="Delete"
                                                href="<?php echo base_url(); ?>Delete/info_producto/<?php echo $single_value->compra_id; ?>">
