<div class="box box-info">
	<p style="padding: 3px;">
		<button id="print_button" title="Click to Print" type="button"
				onClick="window.print()" class="btn btn-flat fa fa-print">Imprimir
		</button>
	</p>
...
<!--			</tr>-->
			<tr>
				...
				<th style="text-align: center;">Descuento total</th>
			</tr>
			</thead>
			<tbody>
			<?php
				...
				foreach (${"product_result" . $i} as $single_value) {
					...
					<?php if ($single_value->informe  != "Previous Due" && $single_value->informe  != "Payment") { ?>
						<?php if ($one_time == 1) { ?>
							...
							<?php  $precio_total2 += $single_value->precio_descuento; ?>
							</tr>
						<?php } else { ?>
...
<!--							<td style="text-align: center;">--><?php //echo $single_value->precio_descuento; ?><!--/-</td>-->
			...
			<tr style="font-weight: bolder;">
				<td style="text-align: right;" colspan="5">Productos totales</td>
				<td style="text-align: center;"><?php echo $total_qty; ?></td>
				<td style="text-align: center;" colspan="3"></td>
				<td style="text-align: center;">Total ventas: <?php echo '$'.$precio_total2; ?>/-</td>
