			...
			<div class="col-md-3"  id="no_print3">
				<div class="list-group">
					<a href="index.html" class="list-group-item active main-color-bg">
						<span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Ventas</a>
					<a href="<?php echo base_url(); ?>ShowForm/venta_productos/main"
					   class="list-group-item active">
						<span class="	" aria-hidden="true"></span> Ventas de productos</a>
					<a href="<?php echo base_url(); ?>ShowForm/declaracion_ventas/main"
					   class="list-group-item">
						<span class="	" aria-hidden="true"></span> Declaración de ventas</a>
				...
				<div class="rounded-0 panel panel-default">
					...
					<table id="salesList" class="table table-bordered table-hover">
						...
						<tr>
							...
							<td colspan="2">
								Subtotal<input type="text" class="form-control" id="sub_total"
												value="0" style="color: black; border: black 2px solid;"
												name="sub_total" readonly>
							</td>
							<td colspan="2">
								Cantidad pagada<input type="number" class="form-control" id="pay"
...
<script type="text/javascript">
	$("#nombre_producto").on("change paste keyup", function () {
		...
		var post_data = {
			'nombre_producto': nombre_producto,'nombre_producto_id': nombre_producto_id,
	...
	$("#add_item").click(function () {
		...
		$('#cantidad').val('0');
		$('#nombre_producto').val('');$('#precio_compra').val('');
		product_count++;
