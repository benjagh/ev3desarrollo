<?php if (!empty($all_product_info)) { ?>
    <div class="box box-info">
        <div class="box-header">
            <h3 class="box-title" style="color: black;">Ganancia  / Perdida
			...
			<p style="">
				<button id="print_button" title="Click to Print" type="button"
						onClick="window.print()" class="">Imprimir
				</button>
			</p>
        </div>
            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Precio de compra <br> (por unidad)</th>
                        <th style="text-align: center;">Precio de venta <br> (por unidad)</th>
                        <th style="text-align: center;">Ganancia  / Perdida<br> (por unidad)</th>
...
<!--						<td></td>-->
<!--                        <td style="text-align: center;">--><?php //echo $precio_total; ?><!--  [Balance]</td>-->
<!--                    </tr>-->
                </tbody>
            </table>
        </div>
